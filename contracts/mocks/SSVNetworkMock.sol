...
import "../interfaces/utils/VersionedContract.sol";
import "../interfaces/utils/Types.sol";
import "../interfaces/ISSVNetwork.sol";

contract SSVNetworkMock is OwnableUpgradeable, ISSVNetwork, VersionedContract {
    ...
    ISSVRegistry public _ssvRegistryContract;
    ...
    /**@notice this function is for testing depositing keyshares locally */
    function setRegistryContract(address addr) public returns (address){
        _ssvRegistryContract = ISSVRegistry(addr);
        return addr;
    }
    /**@notice this function is for testing depositing keyshares locally */
    function setTokenAddress(address addr) public returns(address) {
        _token = IERC20(addr);
        return addr;
    }
